...
public class RtpPacket {
	...
	public void printString(){
		Log.d("RtpPacket", "Length:" + getLength() + " HeaderLength:" + getHeaderLength()
				+ " Version:" + getVersion() + " Padding:" + hasPadding()
				+ " Extension:" + hasExtension() + " CscrCount:"+ getCscrCount()
				+ " Marker:" + hasMarker() + " PayloadType:" + getPayloadType()
				+ " SequenceNumber:" + getSequenceNumber() + " Timestamp:" + getTimestamp()
				+ " Sscr:" + getSscr());
	}
}
